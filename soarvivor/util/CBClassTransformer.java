...
public class CBClassTransformer implements IClassTransformer
{
	 ...
	 * 
	 * @see
	 * net.minecraft.launchwrapper.IClassTransformer#transform(java.lang.String,
	...
	public byte[] transform(String arg0, String arg1, byte[] arg2)
	{
		...
		// EntityCreeper.class
		if (arg0.equals("te")
				|| arg0.equals("net.minecraft.entity.monster.EntityCreeper"))
		{
			System.out
					.println("********* INSIDE CREEPER TRANSFORMER ABOUT TO PATCH: "
							+ arg0);
			arg2 = patchClassInJar(arg0, arg2, arg0,
					CBFMLLoadingPlugin.location);
		}
		return arg2;
	}
			...
			File location)
	{
		try
		{
			...
			} else
			{
				...
				zin.read(bytes);
				zin.close();
				System.out.println("[" + "CreeperBurnCore" + "]: " + "Class "
						+ name + " patched!");
			}
			zip.close();
		} catch (Exception e)
