...
public class GuiLimitedInventory extends GuiContainer {
	...
	super(new ContainerLimitedPlayer(player, inventoryPlayer,
		inventoryLimited));
	...
	drawPlayerModel(xPos + 51, yPos + 75, 30, (float) (xPos + 51)
		- this.xSize_lo, (float) (yPos + 75 - 50) - this.ySize_lo,
		this.mc.thePlayer);
    }

    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
	this.fontRenderer.drawString(I18n.getString("container.crafting"), 86,
		16, 4210752);
    }
